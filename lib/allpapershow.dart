...
class allpaper extends StatefulWidget {
  var id;

  allpaper({Key? key,required this.id}) : super(key: key);
...
class _MyAdminState extends State<allpaper> {
  Future<List<dynamic>> showData() async {
    print("w");
    var _message;
    var response = await http.post(
        Uri.parse('http://'+MyApp.ip+'/invigilation/api/std/history'),
        body: {
                ...
                return Column(
                    children: [
                      ...
                      Container(
                        ...
                        padding: EdgeInsets.only(left: 60,top: 5,right: 10,bottom: 10),
