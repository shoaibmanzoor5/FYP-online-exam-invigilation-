...
class upload extends StatefulWidget {
  ...
  upload({Key? key,required this.id}) : super(key: key);
  @override
  _uploadpaperState createState() => _uploadpaperState();
}

class _uploadpaperState extends State<upload> {
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                                width: 170,
                                margin: EdgeInsets.only(left: 27,right: 10),
                                padding: EdgeInsets.symmetric(horizontal: 15.0),
                                color: Colors.blue,
                                child: DropdownButtonHideUnderline(
                                    child: DropdownButton(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                                width: 170,
                                margin: EdgeInsets.only(left: 57,right: 10),
                                padding: EdgeInsets.symmetric(horizontal: 15.0),
                                color: Colors.blue,
                                child: DropdownButtonHideUnderline(
                                    child: DropdownButton(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                                width: 170,
                                margin: EdgeInsets.only(left: 52,right: 10),
                                padding: EdgeInsets.symmetric(horizontal: 15.0),
                                color: Colors.blue,
                                child: DropdownButtonHideUnderline(
                                    child: DropdownButton(
